  ...
  const totals = useMemo(() => {
    ...
    return rows.reduce(
      (acc, r) => ({
        ...
        eomBalance: r.eomBalance,
      }),
      { cashIn: 0, cashOut: 0, netCash: 0, eomBalance: 0 },
    );
  }, [rows]);
  return (
    <div className="panel">
              ...
              {rows.map((r) => (
                <tr key={r.month}>
                  ...
                  <td
                    align="right"
                    style={{
                      color: r.netCash >= 0 ? "var(--ok)" : "var(--bad)",
                    }}
                  >
                    {r.netCash >= 0 ? "+" : ""}${r.netCash.toLocaleString()}
                  </td>
              ...
              <tfoot>
                <tr>
                  ...
                  <td
                    ...
                    style={{
                      fontWeight: 700,
                      color: totals.netCash >= 0 ? "var(--ok)" : "var(--bad)",
                    }}
                  >
                    {totals.netCash >= 0 ? "+" : ""}$
                  ...
                  <td align="right" style={{ fontWeight: 700 }}>
                    ${totals.eomBalance.toLocaleString()}
                  </td>
                </tr>
              </tfoot>
            )}
